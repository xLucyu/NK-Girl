...
NOKEYS = ["MaxParagons", "MaxTowers", "LeastTiers", "LeastCash"]
...
def filterModifiers(modifiers: dict, emotes: dict) -> list[str]:
    ...
    activeModifiers = {
        ...
        if modifier not in NOKEYS and multiplier not in [False, 9999, 1, -1]
        or modifier in NOKEYS and multiplier not in [9999, -1]
    }
